...
<!-- begin #content -->
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Actor View</h1>
    <!-- end page-header -->
        ...
        <!-- begin col-12 -->
            ...
            <!-- begin panel -->
                <div class="panel panel-inverse">
                    ...
                    <h4 class="panel-title">Actor View</h4>
                    </div>
                    <div class="panel-body">
                        <p>
                            <a class="btn btn-primary btn-sm " href="<?php echo site_url('MusicCtr/Actor/add'); ?>">
